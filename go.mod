...
require (
	...
	github.com/TomBowyerResearchProject/common/logger v0.0.0-20210424013532-4411be89261b
	github.com/TomBowyerResearchProject/common/middlewares v0.0.0-20210423101122-6f535e949eb8
	github.com/TomBowyerResearchProject/common/mongo v0.0.0-20210424083646-3a42927f9fb4
